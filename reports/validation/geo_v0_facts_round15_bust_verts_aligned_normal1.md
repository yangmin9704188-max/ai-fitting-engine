# Geometric v0 Facts-Only Summary (Round 15 - Bust Verts Aligned, Fastmode normal_1)

## 1. 실행 조건

- **샘플 수**: 6
- **입력 데이터셋**: `verification/datasets/golden/core_measurements_v0/s0_synthetic_cases.npz`
- **Git SHA**: `63007204531a1d52b412133a35ef588c51f335ac`
- **실행 일시**: 2026-01-25T15:54:53.276527
...
### 1.2 Bust verts alignment (normal_1, fastmode)
