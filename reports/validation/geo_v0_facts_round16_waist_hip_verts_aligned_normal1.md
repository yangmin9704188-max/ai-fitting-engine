# Geometric v0 Facts-Only Summary (Round 16 - Waist/Hip Verts Aligned, Fastmode normal_1)

## 1. 실행 조건

- **샘플 수**: 6
- **입력 데이터셋**: `verification/datasets/golden/core_measurements_v0/s0_synthetic_cases.npz`
- **Git SHA**: `1f9c2d2cab2875a2e82b11ad07de4dcfc74d20cb`
- **실행 일시**: 2026-01-25T16:03:21.829103

### 1.1 S0 Dataset Scale Statistics

- **HEIGHT_M**: min=1.710m, median=1.710m, max=1.710m
- **BUST_CIRC_M**: median=1.188m, BUST/height ratio=0.695
- **WAIST_CIRC_M**: median=0.850m, WAIST/height ratio=0.497
- **HIP_CIRC_M**: median=1.017m, HIP/height ratio=0.594

### 1.2 Bust/waist/hip verts alignment (normal_1, fastmode)

| Field | Value |
|-------|-------|
| bust_circ_after_scale_theoretical | 1.2701m |
| bust_circ_from_verts_before | 1.9084m |
| bust_circ_from_verts_after | 0.9673m |
| waist_circ_from_verts_before | 2.0499m |
| waist_circ_from_verts_after | 1.0390m |
| hip_circ_from_verts_before | 1.6985m |
| hip_circ_from_verts_after | 0.8609m |
| bust_xz_scale_factor | 0.6655 |
| waist_xz_scale_factor | 0.5069 |
| hip_xz_scale_factor | 0.6718 |
| torso_xz_scale_factor | 0.5069 |
| clamp_applied | False |
...
|-----|-------------|-----------|----------------|-----|--------|-----|-------------|
| NECK_CIRC_M | 1 | 0 | 0.00% | 0.6305 | 0.6305 | 0.6305 | N/A |
| BUST_CIRC_M | 1 | 0 | 0.00% | 1.1881 | 1.1881 | 1.1881 | N/A |
| UNDERBUST_CIRC_M | 1 | 0 | 0.00% | 1.1467 | 1.1467 | 1.1467 | N/A |
| WAIST_CIRC_M | 1 | 0 | 0.00% | 0.8497 | 0.8497 | 0.8497 | N/A |
| HIP_CIRC_M | 1 | 0 | 0.00% | 1.0166 | 1.0166 | 1.0166 | N/A |
| THIGH_CIRC_M | 1 | 0 | 0.00% | 1.2099 | 1.2099 | 1.2099 | N/A |
| MIN_CALF_CIRC_M | 1 | 0 | 0.00% | 0.8219 | 0.8219 | 0.8219 | N/A |
| CHEST_WIDTH_M | 1 | 0 | 0.00% | 0.3625 | 0.3625 | 0.3625 | N/A |
| CHEST_DEPTH_M | 1 | 0 | 0.00% | 0.3480 | 0.3480 | 0.3480 | N/A |
| WAIST_WIDTH_M | 1 | 0 | 0.00% | 0.2608 | 0.2608 | 0.2608 | ✅ PASS |
| WAIST_DEPTH_M | 1 | 0 | 0.00% | 0.2595 | 0.2595 | 0.2595 | ✅ PASS |
| HIP_WIDTH_M | 1 | 0 | 0.00% | 0.3278 | 0.3278 | 0.3278 | ✅ PASS |
| HIP_DEPTH_M | 1 | 0 | 0.00% | 0.3063 | 0.3063 | 0.3063 | ✅ PASS |
...
|------|--------------|-----------------|--------------|
| x | 0.3929 | 0.3929 | 0.3929 |
| y | 1.7101 | 1.7101 | 1.7101 |
| z | 0.3797 | 0.3797 | 0.3797 |
