...
- `NON_NUMERIC_VALUES`: Column contains non-numeric values (e.g., HUMAN_ID, SEX, AGE or other text columns); recorded to avoid false ALL_NULL_* warnings for non-numeric columns
