...
- [ ] LINEAGE.md의 source 추적성 확인
- [ ] Round 연속성 확인 (`docs/verification/round_registry.json`)
- [ ] Artifact 완성도 확인 (KPI.md, KPI_DIFF.md, LINEAGE.md 모두 존재)
- [ ] Baseline 설정 고려 (`docs/ops/baselines.json` 업데이트)
