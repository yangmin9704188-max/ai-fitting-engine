...
- L3 Geometric: [GEOMETRIC_DESIGN_BUST_UNDERBUST_V0.md](GEOMETRIC_DESIGN_BUST_UNDERBUST_V0.md)
- L4 Validation: [VALIDATION_FRAME_BUST_UNDERBUST_V0.md](VALIDATION_FRAME_BUST_UNDERBUST_V0.md)
